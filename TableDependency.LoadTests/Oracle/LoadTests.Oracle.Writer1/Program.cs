...
namespace LoadTests.Oracle.Writer1
{
    class Program
    {
                    ...
                    while (true)
                    {
                        switch (new Random().Next(1, 3))
                        {
                            ...
                            case 2:
                                ...
                                sql = $"INSERT INTO PRODUCTS (ID, NAME, \"Long Description\") VALUES ({id}, '{DateTime.Now.ToString("dd/MM/yyyy hh:mm:ss")}', '{"<en>INSERT from Writer 1<en>"}')";
                                break;
                            case 3:
