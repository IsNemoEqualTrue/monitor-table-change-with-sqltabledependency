...
{
    [TestClass]
    public class DisposeAndRestartWithSameObjects
    {
        ...
        public void Test()
        {
            ...
            using (var tableDependency = new OracleTableDependency<Item>(ConnectionString, TableName, mapper, null, false))
            {
            ...
            using (var tableDependency = new OracleTableDependency<Item>(ConnectionString, TableName, mapper, null, true, namingToUse))
            {
                tableDependency.OnChanged += TableDependency_Changed;
                tableDependency.Start();
