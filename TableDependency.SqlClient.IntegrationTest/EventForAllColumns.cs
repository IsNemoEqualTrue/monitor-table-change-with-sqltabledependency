...
namespace TableDependency.SqlClient.IntegrationTest
{
    ...
    public class EventForAllColumns
    {
        ...
        private static void ModifyTableContent()
        {
            ...
            _checkValues.Add(ChangeType.Update.ToString(), new Tuple<Customer, Customer>(new Customer { Name = "Velia", Surname = "Ceccarelli" }, new Customer()));
            _checkValues.Add(ChangeType.Delete.ToString(), new Tuple<Customer, Customer>(new Customer { Name = "Velia", Surname = "Ceccarelli" }, new Customer()));
