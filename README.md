...
* [Monitor table change with Blazor](https://github.com/christiandelbianco/blazor-notification-db-record-change): This example uses .NET CORE 3.0 Blazor (server side) to create a single page application that update in real-time its content on database record changes.
