...
* Server/windows service hosting SqlTableDependency **must not goes to SLEEP mode**. Sleep mode blocks SqlTableDependency code and this result in running the database watch dog that drops all SqlTableDependency's db objects.
