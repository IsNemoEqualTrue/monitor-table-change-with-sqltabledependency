...
{
    public class TeardownTestSqlserver1Model
    {
    ...
    public class TeardownTestSqlserver1
    {
        ...
        private static List<TeardownTestSqlserver1Model> _notifiedValues = new List<TeardownTestSqlserver1Model>();
        ...
        {
            string naming = "TestTeardown1";
            SqlTableDependency<TeardownTestSqlserver1Model> tableDependency = null;
            string dataBaseObjectsNamingConvention = null;

            var mapper = new ModelToTableMapper<TeardownTestSqlserver1Model>();
            ...
            try
            {
                tableDependency = new SqlTableDependency<TeardownTestSqlserver1Model>(ConnectionString, mapper: mapper, teardown: false, namingForObjectsAlreadyExisting: naming);
            ...
            try
            {
                tableDependency = new SqlTableDependency<TeardownTestSqlserver1Model>(ConnectionString, mapper: mapper, teardown: true, namingForObjectsAlreadyExisting: naming);
                tableDependency.OnChanged += TableDependency_Changed;
                tableDependency.Start();
                dataBaseObjectsNamingConvention = tableDependency.DataBaseObjectsNamingConvention;
                Assert.AreEqual(dataBaseObjectsNamingConvention, naming);
        ...
        private static void TableDependency_Changed(object sender, RecordChangedEventArgs<TeardownTestSqlserver1Model> e)
        {
            switch (e.ChangeType)
            {
                case ChangeType.Insert:
                    _notifiedValues.Add(new TeardownTestSqlserver1Model() { Id = e.Entity.Id, Name = e.Entity.Name, Description = e.Entity.Description });
                    break;
            }
        }
        ...
        private static void ModifyTableContent()
        {
            using (var sqlConnection = new SqlConnection(ConnectionString))
            {
                ...
                using (var sqlCommand = sqlConnection.CreateCommand())
                {
                    _insertedValues.Add(new TeardownTestSqlserver1Model { Id = _counter, Name = "Christian", Description = "Del Bianco" });
                    ...
                    _insertedValues.Add(new TeardownTestSqlserver1Model { Id = _counter, Name = "Valentina", Description = "Del Bianco" });
                    ...
                    _insertedValues.Add(new TeardownTestSqlserver1Model { Id = _counter, Name = "Aurelia", Description = "Bezerra" });
