...
{
    [TestClass]
    public class EventForAllColumnsTestSqlServerUsingRoleDbOwner
    {
        private static string _connectionString = ConfigurationManager.ConnectionStrings["db_owner_SqlServerConnectionString"].ConnectionString;
