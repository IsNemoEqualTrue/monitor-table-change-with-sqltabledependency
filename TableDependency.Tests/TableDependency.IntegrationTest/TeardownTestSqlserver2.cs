...
{
    public class TeardownTestSqlserver2Model
    {
    ...
    [TestClass]
    public class TeardownTestSqlserver2
    {
        private static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["SqlServerConnectionString"].ConnectionString;
        private static readonly string TableName = "TeardownTestSqlserver2Model";
        private static int _counter = 1;
        private static List<TeardownTestSqlserver2Model> _insertedValues = new List<TeardownTestSqlserver2Model>();
        private static List<TeardownTestSqlserver2Model> _notifiedValues = new List<TeardownTestSqlserver2Model>();
        ...
        public void TeardownTests()
        {
            ...
            SqlTableDependency<TeardownTestSqlserver2Model> tableDependency = null;
            string dataBaseObjectsNamingConvention = null;

            var mapper = new ModelToTableMapper<TeardownTestSqlserver2Model>();
            ...
            try
            {
                tableDependency = new SqlTableDependency<TeardownTestSqlserver2Model>(ConnectionString, mapper: mapper, teardown: false, namingForObjectsAlreadyExisting: naming);
            ...
            // Wait time requered from watch dog
            ...
            try
            {
                tableDependency = new SqlTableDependency<TeardownTestSqlserver2Model>(ConnectionString, mapper: mapper, teardown: true, namingForObjectsAlreadyExisting: naming);
                tableDependency.OnChanged += TableDependency_Changed;
                tableDependency.Start();
                dataBaseObjectsNamingConvention = tableDependency.DataBaseObjectsNamingConvention;
                Assert.AreEqual(dataBaseObjectsNamingConvention, naming);
        ...
        private static void TableDependency_Changed(object sender, RecordChangedEventArgs<TeardownTestSqlserver2Model> e)
        {
            switch (e.ChangeType)
            {
                case ChangeType.Insert:
                    _notifiedValues.Add(new TeardownTestSqlserver2Model() { Id = e.Entity.Id, Name = e.Entity.Name, Description = e.Entity.Description });
                    break;
            }
        }
        ...
        private static void ModifyTableContent()
        {
            using (var sqlConnection = new SqlConnection(ConnectionString))
            {
                ...
                using (var sqlCommand = sqlConnection.CreateCommand())
                {
                    _insertedValues.Add(new TeardownTestSqlserver2Model { Id = _counter, Name = "Christian", Description = "Del Bianco" });
                    ...
                    _insertedValues.Add(new TeardownTestSqlserver2Model { Id = _counter, Name = "Valentina", Description = "Del Bianco" });
                    ...
                    _insertedValues.Add(new TeardownTestSqlserver2Model { Id = _counter, Name = "Aurelia", Description = "Bezerra" });
