...
{
    public class TeardownTestSqlserver4Model
    {
    ...
    [TestClass]
    public class TeardownTestSqlserver4
    {
        private static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["SqlServerConnectionString"].ConnectionString;
        private static readonly string TableName = "TeardownTestSqlserver4Model";
        private static int _counter = 1;
        private static List<TeardownTestSqlserver4Model> _insertedValues = new List<TeardownTestSqlserver4Model>();
        private static List<TeardownTestSqlserver4Model> _notifiedValues = new List<TeardownTestSqlserver4Model>();
        ...
        private static void TableDependency_Changed(object sender, RecordChangedEventArgs<TeardownTestSqlserver4Model> e)
        {
            switch (e.ChangeType)
            {
                case ChangeType.Insert:
                    _notifiedValues.Add(new TeardownTestSqlserver4Model() { Id = e.Entity.Id, Name = e.Entity.Name, Description = e.Entity.Description });
                    break;
            }
        }
        ...
        private static void ModifyTableContent()
        {
            using (var sqlConnection = new SqlConnection(ConnectionString))
            {
                ...
                using (var sqlCommand = sqlConnection.CreateCommand())
                {
                    _insertedValues.Add(new TeardownTestSqlserver4Model { Id = _counter, Name = "Christian", Description = "Del Bianco" });
                    ...
                    _insertedValues.Add(new TeardownTestSqlserver4Model { Id = _counter, Name = "Valentina", Description = "Del Bianco" });
                    ...
                    _insertedValues.Add(new TeardownTestSqlserver4Model { Id = _counter, Name = "Aurelia", Description = "Bezerra" });
