...
{
    [TestClass]
    public class EventForAllColumnsTestSqlServerUsingWIA
    {
        private static string _connectionString = ConfigurationManager.ConnectionStrings["WIASqlServerConnectionString"].ConnectionString;
